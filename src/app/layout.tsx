...
export const metadata: Metadata = {
  title: "Pizzeria Restaurant - Best Pizza in Town",
  description: "Discover the best pizza in town with our pizzeria's handcrafted specialties.",
  keywords: "pizzeria, pizza, restaurant, Italian food",
  openGraph: {
    title: "Pizzeria Restaurant - Best Pizza in Town",
    description: "Discover the best pizza in town with our pizzeria's handcrafted specialties.",
    siteName: "Pizzeria",
